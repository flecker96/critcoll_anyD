...
C     **********************
      ...
      call system('mkdir 256')

      open(unit=10, file='256/Delta.dat', status='new')
      write(10,99) Delta
      close(10)

      open(unit=10, file='256/fc.dat', status='new')
      do j=1,2*ny
         write(10,99) fout(j)
      end do
      close(10)

      open(unit=10, file='256/psic.dat', status='new')
      do j=1,2*ny
         write(10,99) psiout(j)
      end do
      close(10)     

      open(unit=10, file='256/Up.dat', status='new')
      do j=1,2*ny
         write(10,99) uout(j)
      end do
      close(10)
