      ...
      if (debug) then
         ...
         if (tstep.eq.1) then
            ...
            open(unit=14,file='R_taylor/ia2right.junk',status='new')
               ...
               do j=1,ny
                  write(11,*) f0(j), f1(j), f2(j), f3(j)
                  write(12,*) u0(j), u1(j), u2(j), u3(j)
                  write(13,*) v0(j), v1(j), v2(j), v3(j)
                  write(14,*) ia20(j), ia21(j), ia22(j), ia23(j)
               end do
            ...
            call changeresolution(ny, ny/2, f3, f3)
            ...
            call changeresolution(ny, ny/2, ia23, ia23)
