...
C *** Order 4 ***
     ...
     $         (8.d0*f0(j)*(-2.d0*du1dtau(j)**2*f0(j) + 
     $          (2.d0*(-1.d0 + d)*df0dtau(j)*du1dtau(j) + 
     $           (-((-1.d0 + d)*d2u1dtau2(j)) + 
     $          (1.d0 - 3.d0*d + 2.d0*lamb - 2.d0*d*lamb)*du1dtau(j)
     $                    )*f0(j))*u1(j) + 
     $              (-1.d0 + d)*df0dtau(j)*u1(j)**2) + 
     $           4.d0*f0(j)*u1(j)*
     $            ((-5.d0 + d)*(-2.d0 + d)**3*(-1.d0 + d)*f0(j)**3*
     $               u1(j)**3 + 
     $              2.d0*(-1.d0 + d)*df0dtau(j)*
     $               (du1dtau(j) + (2.d0 + lamb)*u1(j)) + 
     $              2.d0*f0(j)*(-((-1.d0 + d)*d2u1dtau2(j)) + 
     $                 (1.d0 - 3.d0*d - 2.d0*lamb)*du1dtau(j) + 
     $                 (2.d0 + lamb + lamb**2 - 
     $                    d*(4.d0 + lamb*(3.d0 + lamb)))*u1(j))) + 
     $        f0(j)*((-5.d0 + d)*(-2.d0 + d)**3*(-1.d0 + d)*f0(j)**3*
     $               u1(j)**4 - 
     $              16.d0*(-1.d0 + d)*df0dtau(j)*u1(j)*
     $               (du1dtau(j) + u1(j)) + 
     $              8.d0*f0(j)*(du1dtau(j)**2 + 
     $                 ((-1.d0 + d)*d2u1dtau2(j) + 
     $              (-1.d0 + 3.d0*d + (-1.d0 + d)*lamb)*du1dtau(j))*
     $                u1(j) + 
     $           (-1.d0 + 2.d0*d + (-1.d0 + d)*lamb)*u1(j)**2))))/
     $       (128.d0 * (-1.d0 + d)**2*(1.d0 + d)*f0(j)**3)

         u4(j) = (f0(j)*u1(j)*(-6.d0*(-1.d0 + d)*(1.d0 + lamb)*
     $            df0dtau(j)**2 + 
     $           2.d0*(-1.d0 + d)*(1.d0 + lamb)*
     $            (d2f0dtau2(j) + (7.d0 + 3.d0*lamb)*df0dtau(j))*f0(j)
     $             - 2.d0*(-1.d0 + d)*
     $            (6.d0 + 11.d0*lamb + 6.d0*lamb**2 + lamb**3)*f0(j)**2
     $            + (-2.d0 + d)**3*(3.d0 - 7.d0*d + 2.d0*d**2)*f0(j)**4*
     $            u1(j)*(2.d0*du1dtau(j) + (3.d0 + lamb)*u1(j))) + 
     $        f0(j)*(-2.d0*(-1.d0 + d)*
     ...
     $            f0(j)**4*u1(j)**2 - 
     $           6.d0*(-1.d0 + d)*df0dtau(j)*
     $            (3.d0*df0dtau(j)*du1dtau(j) + 2.d0*df0dtau(j)*u1(j))
     $             + 2.d0*(-1.d0 + d)*f0(j)*
     $            (6.d0*d2u1dtau2(j)*df0dtau(j) + 
     $              d2f0dtau2(j)*du1dtau(j) + 
     $              10.d0*df0dtau(j)*du1dtau(j) + 
     $              2.d0*lamb*df0dtau(j)*du1dtau(j) + 
     $              (d2f0dtau2(j) + 2.d0*(5.d0 + 3.d0*lamb)*df0dtau(j))*
     $               du1dtau(j) + 
     $              (d2f0dtau2(j) + (7.d0 + 2.d0*lamb)*df0dtau(j))*
     $               u1(j))) + 
     $        f0(j)*(30.d0*(-1.d0 + d)*df0dtau(j)**2*
     $            (du1dtau(j) + u1(j)) - 
     $           (-2.d0 + d)**3*(3.d0 - 7.d0*d + 2.d0*d**2)*f0(j)**4*
     $            u1(j)**2*(du1dtau(j) + u1(j)) + 
     $           2.d0*(-1.d0 + d)*f0(j)**2*
     $            (3.d0*((6.d0 + lamb)*d2u1dtau2(j) + d3u1dtau3(j)) + 
     $              (33.d0 + 10.d0*lamb + lamb**2)*du1dtau(j) + 
     $              (18.d0 + 7.d0*lamb + lamb**2)*u1(j)) - 
     $           4.d0*(-1.d0 + d)*f0(j)*
     ...
     $      (4.d0*(-1.d0 + d)**2*(1.d0 + d)*f0(j)**6)
         ...
         ia24(j) = ((-2.d0 + d)**3*(f0(j)*
     $           (-2.d0*du1dtau(j)**2*f0(j) + 
     $             (2.d0*(-1.d0 + d)*df0dtau(j)*du1dtau(j) + 
     $                (-((-1.d0 + d)*d2u1dtau2(j)) + 
     $                   (1.d0 - 3.d0*d + 2.d0*lamb - 2.d0*d*lamb)*
     $                    du1dtau(j))*f0(j))*u1(j) + 
     $             (-1.d0 + d)*df0dtau(j)*u1(j)**2) + 
     $          f0(j)*u1(j)*((-2.d0 + d)**4*(-1.d0 + d)*f0(j)**3*
     $              u1(j)**3 + 
     $             (-1.d0 + d)*df0dtau(j)*
     $              (du1dtau(j) + (2.d0 + lamb)*u1(j)) + 
     $             f0(j)*(-((-1.d0 + d)*d2u1dtau2(j)) + 
     $                (1.d0 - 3.d0*d - 2.d0*lamb)*du1dtau(j) + 
     $                (2.d0 + lamb + lamb**2 - 
     $                   d*(4.d0 + lamb*(3.d0 + lamb)))*u1(j))) + 
     $          f0(j)*(-3.d0*(-1.d0 + d)*df0dtau(j)*u1(j)*
     $              (du1dtau(j) + u1(j)) + 
     $             f0(j)*(2.d0*du1dtau(j)**2 + 
     $                (2.d0*(-1.d0 + d)*d2u1dtau2(j) + 
     $                   (-2.d0 - lamb + d*(6.d0 + lamb))*du1dtau(j))*
     $                 u1(j) + 
     $                (-2.d0 - lamb + d*(4.d0 + lamb))*u1(j)**2))))/
     $      (4.d0*(-1.d0 + d)**2*(1.d0 + d)*f0(j)**4)
      end do

C *** Order 5 ***
      
      do j=1,ny
         u5(j) =  (f0(j)*u1(j)*(-240.d0*(-1.d0 + d)*(1.d0 + lamb)*
     $            df0dtau(j)**3 + 
     $           80.d0*(-1.d0 + d)*(1.d0 + lamb)*df0dtau(j)*
     $            (2.d0*d2f0dtau2(j) + (8.d0 + 3.d0*lamb)*df0dtau(j))*
     $            f0(j) - 16.d0*(-1.d0 + d)*(1.d0 + lamb)*
     ...
     $        8.d0*(f0(j)*(210.d0*(-1.d0 + d)*df0dtau(j)**3*
     $               (du1dtau(j) + u1(j)) - 
     $              3.d0*(-3.d0 + d)*(-2.d0 + d)**3*(-1.d0 + 4.d0*d)*
     $               df0dtau(j)*f0(j)**4*u1(j)**2*
     $               (du1dtau(j) + u1(j)) - 
     $              2.d0*(-1.d0 + d)*f0(j)**3*
     $               (4.d0*(35.d0 + lamb*(10.d0 + lamb))*d2u1dtau2(j) + 
     $                 6.d0*lamb*d3u1dtau3(j) + 
     $                 4.d0*(10.d0*d3u1dtau3(j) + d4u1dtau4(j)) + 
     $                 (200.d0 + lamb*(80.d0 + lamb*(15.d0 + lamb)))*
     $                  du1dtau(j) + 
     $                 (6.d0 + lamb)*(16.d0 + lamb*(5.d0 + lamb))*u1(j))
     $               - 30.d0*(-1.d0 + d)*df0dtau(j)*f0(j)*
     $               (4.d0*d2f0dtau2(j)*du1dtau(j) + 
     $                 df0dtau(j)*
     $                  (6.d0*d2u1dtau2(j) + 
     $                    (22.d0 + 3.d0*lamb)*du1dtau(j)) + 
     $                 (4.d0*d2f0dtau2(j) + 
     $                    (16.d0 + 3.d0*lamb)*df0dtau(j))*u1(j)) + 
     $              10.d0*(-1.d0 + d)*f0(j)**2*
     $               (d3f0dtau3(j)*du1dtau(j) + 
     $                 d2f0dtau2(j)*
     $                  (4.d0*d2u1dtau2(j) + 
     $                    (15.d0 + 2.d0*lamb)*du1dtau(j)) + 
     $                 2.d0*df0dtau(j)*
     $                  ((20.d0 + 3.d0*lamb)*d2u1dtau2(j) + 
     $                    3.d0*d3u1dtau3(j) + 
     $                    (40.d0 + lamb*(11.d0 + lamb))*du1dtau(j)) + 
     $                 ((11.d0 + 2.d0*lamb)*d2f0dtau2(j) + 
     $                    d3f0dtau3(j) + 
     ...
     $                 80.d0*d2u1dtau2(j)*df0dtau(j) + 
     $                 26.d0*lamb*d2u1dtau2(j)*df0dtau(j) + 
     $                 12.d0*d3u1dtau3(j)*df0dtau(j) + 
     $                 15.d0*d2f0dtau2(j)*du1dtau(j) + 
     $                 3.d0*lamb*d2f0dtau2(j)*du1dtau(j) + 
     $                 d3f0dtau3(j)*du1dtau(j) + 
     $                 80.d0*df0dtau(j)*du1dtau(j) + 
     $                 30.d0*lamb*df0dtau(j)*du1dtau(j) + 
     ...
     $                 4.d0*d2f0dtau2(j)*df0dtau(j)*du1dtau(j) + 
     $                 22.d0*df0dtau(j)**2*du1dtau(j) + 
     $                 4.d0*lamb*df0dtau(j)**2*du1dtau(j) + 
     $                 df0dtau(j)*
     $                  (2.d0*d2f0dtau2(j) + 
     $                    (11.d0 + 6.d0*lamb)*df0dtau(j))*du1dtau(j)
     $                  + 2.d0*(d2f0dtau2(j)*df0dtau(j) + 
     $                    df0dtau(j)*
     $                     (d2f0dtau2(j) + 
...
C     Put together the expansion around x=0. 
      do j=1,ny
         ...
         u(j) = x * u1(j) + x**2 * u2(j)   
     $          + x**3 * u3(j) + x**4 * u4(j) + x**5 * u5(j)
         v(j) = x * v1(j) + x**2 * v2(j)  
     $          + x**3 * v3(j) + x**4 * v4(j) + x**5 * v5(j)
         ia2(j) = x**2 *ia22(j) + x**4 * ia24(j)
      end do
